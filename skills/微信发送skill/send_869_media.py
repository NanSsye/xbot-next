#!/usr/bin/env python3
"""
@input: 当前脚本目录下的 wechat-869.json（baseUrl/key）；869 HTTP API（/message/*、/other/*）；可选 ffmpeg（用于从视频抽帧生成封面）；可选 pillow（用于将封面归一为 240x160 JPEG）；可选 sidecar 图片（与视频同目录的 jpg/png）
...
DEFAULT_CONFIG_PATH = SCRIPT_DIR / "wechat-869.json"
