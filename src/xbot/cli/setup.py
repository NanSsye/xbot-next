...
def _llm_updates(values: dict[str, str], *, yes: bool) -> dict[str, str]:
    ...
    updates = {
        ...
        "XBOT_LLM_MULTIMODAL_ENABLED": values.get("XBOT_LLM_MULTIMODAL_ENABLED") or "false",
        "XBOT_LLM_IMAGE_INPUT_ENABLED": values.get("XBOT_LLM_IMAGE_INPUT_ENABLED") or "false",
        "XBOT_LLM_VIDEO_INPUT_ENABLED": values.get("XBOT_LLM_VIDEO_INPUT_ENABLED") or "false",
        "XBOT_LLM_MAX_IMAGE_BYTES": values.get("XBOT_LLM_MAX_IMAGE_BYTES") or "10485760",
        "XBOT_LLM_MAX_VIDEO_BYTES": values.get("XBOT_LLM_MAX_VIDEO_BYTES") or "52428800",
...
def _write_env(path: Path, values: dict[str, str], updates: dict[str, str]) -> None:
    ...
    ordered_keys = [
        ...
        "XBOT_LLM_MULTIMODAL_ENABLED",
        "XBOT_LLM_IMAGE_INPUT_ENABLED",
        "XBOT_LLM_VIDEO_INPUT_ENABLED",
        "XBOT_LLM_MAX_IMAGE_BYTES",
        "XBOT_LLM_MAX_VIDEO_BYTES",
